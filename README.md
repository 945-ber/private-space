...
- 系统设置：中 / 英 / 法 / 德四语言一键切换，覆盖全部界面文字（导航、按钮、帖子标签、更新说明、错误提示、提示气泡均随语言切换，切换后列表即时重渲）；内置版本更新说明
...
| v11 | 全量界面多语言适配：AI 帖子标签、更新说明、服务端错误提示、toast、设置面板全部随语言切换；切换语言后列表即时重渲 |